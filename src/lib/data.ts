...
//     title: "Handicap",
//     description:
//       "A measure of a golfer's ability, expressed as a number, used to level the playing field in competition. A lower handicap indicates a better player.",
//   },
//   {
//     title: "Birdie",
//     description:
//       "Scoring one stroke under par on a hole. For example, if par for a hole is 4 and a golfer completes it in 3 strokes, they have made a birdie.",
//   },
//   {
//     title: "Bogey",
//     description:
//       "Scoring one stroke over par on a hole. If par for a hole is 4 and a golfer completes it in 5 strokes, they have made a bogey.",
//   },
//   {
//     title: "Eagle",
//     description:
//       "Scoring two strokes under par on a hole. For instance, an eagle is achieved when a golfer completes a par-4 hole in 2 strokes.",
//   },
//   {
//     title: "Mulligan",
//     description:
//       "A do-over or replay of a shot without counting the previous one. It's often an informal and friendly rule used in casual play.",
//   },
//   {
//     title: "Fore",
//     description:
...
export const glossaryMenu = [
  ...
  },
  {
    ...
    section: [
      ...
      {
        term: "Bunker",
        description: "A sand trap on the golf course.",
      },
    ],
  },
  {
...
export const terms = [
  ...
  {
    title: "Approach Shot",
    description: "A shot played towards the green, typically from the fairway.",
  },
  {
    title: "Birdie",
    description: "Scoring one stroke under par on a hole.",
  ...
  {
    title: "Hazard",
    description: "A general term for bunkers or water obstacles on the course.",
  },
  {
    title: "Iron",
    description: "A type of golf club with a flat, metal head.",
  ...
  {
    title: "Stance",
    description: "The position of a golfer's feet before and during a shot.",
  },
  {
    title: "Tee",
    description: "The designated area to start each hole.",
  ...
  {
    title: "Up and Down",
    description: "Completing a hole in two strokes from just off the green.",
  },
  {
    title: "Vardon Grip",
    description:
